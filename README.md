# Formato Condicional: Resaltado automático de KPIs.

Aprender a aplicar formato visual dinámico (colores de fondo y fuente, barras de datos, iconos y semáforos) en tablas, matrices y gráficos directamente 
desde el panel de formato de Power BI. El objetivo es resaltar de forma automática indicadores clave de desempeño (KPIs), como el cumplimiento de objetivos, 
desviaciones o cualquier otra métrica relevante para el análisis, sin necesidad de crear medidas DAX complejas.
...
* 🎮 Kahoot! de repaso: pon a prueba tus conocimientos con el cuestionario interactivo disponible en el siguiente enlace: Acceder al Kahoot!. (https://create.kahoot.it/my-library/kahoots/c2bdd594-17e2-4039-9332-60e25f772c80)
...
- 📊 Prueba y Error: ¡No tengas miedo de experimentar! Prueba diferentes paletas y solicita comentarios para refinar tu elección.
- 🌐 Accesibilidad: Considera la accesibilidad de tus colores para garantizar que todos puedan disfrutar de tu informe.
